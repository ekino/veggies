...
const install = ({ baseUrl = "" } = {}) => {
  (0, import_cucumber.Given)(/^(?:I )?set request headers$/, (step) => {
    import_cucumber.world.httpApiClient.setHeaders(
      Cast.getCastedObject(import_cucumber.world.state.populateObject(step.rowsHash()))
    );
  });
  ...
  (0, import_cucumber.Given)(/^(?:I )?assign request headers$/, (step) => {
    const headers = Cast.getCastedObject(import_cucumber.world.state.populateObject(step.rowsHash()));
  ...
  (0, import_cucumber.Given)(/^(?:I )?set request json body$/, (step) => {
    import_cucumber.world.httpApiClient.setJsonBody(
      Cast.getCastedObject(import_cucumber.world.state.populateObject(step.rowsHash()))
    );
  });
  ...
  (0, import_cucumber.Given)(/^(?:I )?set request form body$/, (step) => {
    import_cucumber.world.httpApiClient.setFormBody(
      Cast.getCastedObject(import_cucumber.world.state.populateObject(step.rowsHash()))
    );
  });
  ...
  (0, import_cucumber.Given)(/^(?:I )?set request query$/, (step) => {
    import_cucumber.world.httpApiClient.setQuery(
      Cast.getCastedObject(import_cucumber.world.state.populateObject(step.rowsHash()))
    );
  });
