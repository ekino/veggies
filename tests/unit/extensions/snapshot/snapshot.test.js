...
describe('extensions > snapshot > snapshot', () => {
    ...
    describe('diff', () => {
        afterEach(() => {
            jestDiff.diff.mockReset()
        })

        afterAll(() => {
            jestDiff.diff.mockRestore()
        })
        ...
        test('return a custom diff message when the diff message is not defined', () => {
            ...
            jestDiff.diff.mockReturnValue(undefined)
